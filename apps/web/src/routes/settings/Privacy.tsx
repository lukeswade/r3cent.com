    ...
    <div className="p-4 lg:p-8">
      <div className="page-shell max-w-3xl">
        ...
        <header className="page-header">
          ...
          <h1 className="text-2xl lg:text-3xl font-bold">Privacy</h1>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-2">
            <button
              ...
              className="w-full text-left px-4 py-3 section-card dark:hover:bg-slate-800/50 hover:bg-slate-100 transition-colors text-slate-700 dark:text-slate-300"
            >
